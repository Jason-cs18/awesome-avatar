...
|[arXiv 2024]|[Loopy: Taming Audio-Driven Portrait Avatar with Long-Term Motion Dependency](https://loopyavatar.github.io/)|Zhejiang University and ByteDance|||expressive animation driven by audio only, pre-trained on 160 hours of cleaned training data (collected from internet)|
